...
- **Sprint 11 (proposed, 2026-07-25 brainstorm session, not yet locked):** E17-S1..S9 — Run Deep Analysis paid add-on (fulfills E16-S1's «Разбор запуска» teaser card): comment scraping (Bright Data primary / Apify fallback, D32), Haiku extraction + Sonnet synthesis (D33), Статистика/Рекомендации report UI. Pricing multiplier intentionally unset until a real pilot run's `usage_events` are read (D35) — see BACKLOG.md's 2026-07-25 note and D32–D35
