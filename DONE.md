...
## [Mini App hotfix] iOS auth race + no-project dead end for new accounts
**Completed:** 2026-07-30
**Handover:** direct user bug report, untracked (no story ID) — **needs `/sprint-review` backfill**, same as every prior "hotfix"-labeled entry in this file.
