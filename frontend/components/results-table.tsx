              ...
              {headerGroup.headers.map((header) => {
                ...
                return (
                  <th
                    ...
                    scope="col"
                    className={`sticky top-0 z-10 cursor-pointer select-none whitespace-nowrap bg-gray-50 px-3 py-2 text-left font-medium text-gray-600 dark:bg-gray-900 dark:text-gray-400 ${
