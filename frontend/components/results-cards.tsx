...
import type { ContentItemResponse, ShortlistItemResponse } from "@/lib/api";
...
// ---------------------------------------------------------------------------
// Results cards (plain ContentCard list — sort/export/filters live in
// ResultsControlsBar, rendered by the results page above this list)
// ---------------------------------------------------------------------------
